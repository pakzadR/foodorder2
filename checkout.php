                ...
                <div class="top-links">
                    <div class="container">
                        <ul class="row links">
                            ...
                            <li class="col-xs-12 col-sm-4 link-item ">
                                <span>2</span>
                                <a href="#">Pick Your favorite food</a>
                            </li>
                            <li class="col-xs-12 col-sm-4 link-item active">
                                <span>3</span>
                                <a href="checkout.php">Order and Pay online</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                                ...
                                                <ul class=" list-unstyled">
                                                    <li>
                                                        <label class="custom-control custom-radio  m-b-20">
                                                            ...
                                                            <br>
                                                            <span>Please send your cheque to Store Name, Store Street, Store Town, Store
