                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a
                                    ...
                                    aria-haspopup="true"
                                    aria-expanded="false"><img src="images/users/shutdown.png" alt="user" class="profile-pic"/></a>
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li>
                                        <a href="allrestraunt.php">All Stores</a>
                                    </li>
                                    <li>
                                        <a href="add_category.php">Add Category</a>
                                    </li>
                                    <li>
                                        <a href="add_restraunt.php">Add Restaurant</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li>
                                        <a href="all_menu.php">All Menues</a>
                                    </li>
                                    <li>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-warning">
                                                            <span class="fa fa-cog fa-spin" aria-hidden="true"></span>On a Way!</button>
                                                    </td>
                                                    <?php
																				}
																			if($status=="closed")
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="delete_orders.php?order_del=<?php echo $rows['o_id'];?>"
